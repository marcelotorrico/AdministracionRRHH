...
use MTD\ContratacionEmpleadosBundle\Form\ProyectoEditarType;
...
class EditaProyectoController extends Controller
{
    ...
    public function editarAction(Request $request,$id)
    {
        ...
        return $this->render('MTDContratacionEmpleadosBundle:Proyecto:edita.html.twig', array("proyectoSeleccionado"=>$proyectoSeleccionado,"form"=>$form->createView(), "formularioCliente"=>$formularioCliente->createView(), "formularioTipoProyecto"=>$formularioTipoProyecto->createView()));
    }
