...
class RegistroPostulanteAdministrativoController extends Controller
{
    ...
    public function registrarAction(Request $request)
    {
        ...
        return $this->render('MTDReclutamientoBundle:Reclutamiento:registroAdministrativo.html.twig', array("form"=>$form->createView(), 'proyectos' => $proyectos, "formularioLugar"=>$formularioLugar->createView()));
    }
