...
namespace Proxies\__CG__\MTD\ContratacionEmpleadosBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Cliente extends \MTD\ContratacionEmpleadosBundle\Entity\Cliente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MTD\\ContratacionEmpleadosBundle\\Entity\\Cliente' . "\0" . 'id', '' . "\0" . 'MTD\\ContratacionEmpleadosBundle\\Entity\\Cliente' . "\0" . 'nombre', '' . "\0" . 'MTD\\ContratacionEmpleadosBundle\\Entity\\Cliente' . "\0" . 'apellido', '' . "\0" . 'MTD\\ContratacionEmpleadosBundle\\Entity\\Cliente' . "\0" . 'direccion', '' . "\0" . 'MTD\\ContratacionEmpleadosBundle\\Entity\\Cliente' . "\0" . 'telefono', '' . "\0" . 'MTD\\ContratacionEmpleadosBundle\\Entity\\Cliente' . "\0" . 'nit', '' . "\0" . 'MTD\\ContratacionEmpleadosBundle\\Entity\\Cliente' . "\0" . 'banco', '' . "\0" . 'MTD\\ContratacionEmpleadosBundle\\Entity\\Cliente' . "\0" . 'proyecto');
        }
