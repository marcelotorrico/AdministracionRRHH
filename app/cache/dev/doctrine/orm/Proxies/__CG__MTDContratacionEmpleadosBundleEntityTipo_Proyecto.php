 ...
 */
class Tipo_Proyecto extends \MTD\ContratacionEmpleadosBundle\Entity\Tipo_Proyecto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MTD\\ContratacionEmpleadosBundle\\Entity\\Tipo_Proyecto' . "\0" . 'id', '' . "\0" . 'MTD\\ContratacionEmpleadosBundle\\Entity\\Tipo_Proyecto' . "\0" . 'nombre', '' . "\0" . 'MTD\\ContratacionEmpleadosBundle\\Entity\\Tipo_Proyecto' . "\0" . 'proyecto');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tipo_Proyecto $proxy) {
