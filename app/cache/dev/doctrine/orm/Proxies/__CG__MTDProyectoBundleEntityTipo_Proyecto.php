 ...
 */
class Tipo_Proyecto extends \MTD\ProyectoBundle\Entity\Tipo_Proyecto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MTD\\ProyectoBundle\\Entity\\Tipo_Proyecto' . "\0" . 'id', '' . "\0" . 'MTD\\ProyectoBundle\\Entity\\Tipo_Proyecto' . "\0" . 'nombre', '' . "\0" . 'MTD\\ProyectoBundle\\Entity\\Tipo_Proyecto' . "\0" . 'proyecto');
        }
